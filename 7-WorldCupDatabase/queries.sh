...
echo "$($PSQL "SELECT DISTINCT(name) FROM games RIGHT JOIN teams ON winner_id=team_id OR opponent_id=team_id WHERE year=2014 AND round='Eighth-Final' ORDER BY name")"
